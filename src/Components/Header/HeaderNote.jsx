            ...
            <nav className="bg-white shadow-md sticky top-0 left-0 z-50">
                <div className="container lg:flex items-center justify-between py-5">
                    ...
                    <div className="nav-item">
                        ...
                        <ul className={`lg:flex lg:items-center absolute lg:static bg-white lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-500 ${open ? 'top-[76px] opacity-100' : 'top-[-490px]'} lg:opacity-100 opacity-0`}>
